...
public class TagTest extends UnitTest {
	...
	public void testSimilarPosts() {
		...
		assertEquals(2, bobQuestion1.getSimilarPosts(1, bobQuestion1.tags)
				.size());
		assertEquals(1, bobQuestion1.getSimilarPosts(2, bobQuestion1.tags)
				.size());

		jeffQuestion2.tagItWith("Blue").save();
		assertEquals(2, jeffQuestion2.getSimilarPosts(2, jeffQuestion2.tags)
				.size());
	}
