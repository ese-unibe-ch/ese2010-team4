		...
		#{/if}
		#{if _activity instanceof models.Comment && _activity.post instanceof models.Answer}
		...
		#{/if}
		#{if _activity instanceof models.Comment && _activity.post instanceof models.Question}
